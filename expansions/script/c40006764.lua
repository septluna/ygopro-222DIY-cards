...
function c40006764.initial_effect(c)
	c:EnableReviveLimit()
	c:SetUniqueOnField(1,0,40006764)
	--spsummon limit
...
function c40006764.lvop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and e:IsActiveType(TYPE_MONSTER) and e:GetHandler():GetFlagEffect(1)>0 and c:IsRelateToEffect(e) then return end  
	local e1=Effect.CreateEffect(c)
