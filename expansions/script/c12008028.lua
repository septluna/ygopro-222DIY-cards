...
function c12008028.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if dg:GetCount()>0 then
		...
		local tc=dg:Select(dg,tp,1,2,nil)
...
function c12008028.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c12008028.filter,tp,LOCATION_ONFIELD,0,1,nil) and Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>=5 end
