...
function c81010050.initial_effect(c)
	...
	e1:SetTarget(c81010050.target)
	e1:SetOperation(c81010050.operation)
	c:RegisterEffect(e1)
	--Atk,race
...
function c81010050.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c81010050.operation(e,tp,eg,ep,ev,re,r,rp)
