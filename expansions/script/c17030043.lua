...
function cm.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(17030043,0))
	...
	e2:SetDescription(aux.Stringid(17030043,1))
...
function cm.spfilter(c,e,tp)
	return c:IsCode(17030042) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
