...
function cm.sctg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    ...
    if chk==0 then return Duel.IsPlayerCanSpecialSummonCount(tp,3)
        ...
        and Duel.IsExistingMatchingCard(cm.scfilter1,tp,LOCATION_HAND,0,1,nil,e,tp,e:GetHandler()) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) end
...
function cm.scop(e,tp,eg,ep,ev,re,r,rp)
    ...
    local mc=Duel.SelectMatchingCard(tp,cm.scfilter1,tp,LOCATION_HAND,0,1,1,nil,e,tp,e:GetHandler())
