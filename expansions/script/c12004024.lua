...
function c12004024.spcon(e,c)
	...
	return ((c:IsLocation(LOCATION_HAND) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0) or
		...
		and Duel.IsExistingMatchingCard(c12004024.spfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,nil,RACE_MACHINE)
		and Duel.IsExistingMatchingCard(c12004024.spfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,nil,RACE_SEASERPENT)
end
function c12004024.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g1=Duel.SelectMatchingCard(tp,c12004024.spfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,1,nil,RACE_MACHINE)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=Duel.SelectMatchingCard(tp,c12004024.spfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,1,nil,RACE_SEASERPENT)
	g1:Merge(g2)
