...
function c9910202.initial_effect(c)
	--link summon
	aux.AddLinkProcedure(c,c9910202.lfilter,3,99,c9910202.lcheck)
	c:EnableReviveLimit()
	--spsummon condition
...
function c9910202.splimit(e,se,sp,st)
	if e:GetHandler():IsLocation(LOCATION_EXTRA) then
		return bit.band(st,SUMMON_TYPE_LINK)==SUMMON_TYPE_LINK 
	end
	return true
end
function c9910202.lfilter(c)
