...
function cm.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ffcount>=7 and Duel.IsExistingMatchingCard(cm.actserfilter,tp,LOCATION_DECK,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(31490201,0)) then
...
function cm.spcon(e,c)
	...
	return Duel.IsCanRemoveCounter(e:GetHandlerPlayer(),1,0,0x5310,9,REASON_COST)
end
function cm.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.RemoveCounter(tp,1,0,0x5310,9,REASON_COST)
end
