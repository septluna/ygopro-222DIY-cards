...
function c65020130.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcFun2(c,c65020130.matfilter,aux.FilterBoolFunction(Card.IsFusionSetCard,0xcda4),true)
	--change seq
...
function c65020130.matfilter(c)
	return c:IsFusionType(TYPE_FUSION) and c:IsFusionSetCard(0xcda4) and c:IsAttribute(ATTRIBUTE_FIRE)
end
