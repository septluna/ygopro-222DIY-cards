...
function cm.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(17030015,0))
...
function cm.lcheck(g)
	return g:IsExists(Card.IsRace,1,nil,RACE_WARRIOR+RACE_BEASTWARRIOR)
end
function cm.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_LINK)
end
function cm.thfilter(c)
	return c:IsCode(17030007) and c:IsAbleToHand()
end
