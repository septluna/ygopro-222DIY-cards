...
function c12008009.sprfilter(c,sc)
	return c:IsCanBeLinkMaterial(sc) and c:IsRace(RACE_SEASERPENT) and Duel.IsExistingMatchingCard(c11113170.sprfilter1,tp,LOCATION_MZONE+LOCATION_HAND,0,c) and Duel.GetLocationCountFromEx(tp,tp,c,TYPE_LINK)>0
end
