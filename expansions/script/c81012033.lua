...
function c81012033.spfilter(c,e,tp)
	return c:IsType(TYPE_RITUAL) and c:IsLevelBelow(4) and c:IsType(TYPE_PENDULUM) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.GetLocationCountFromEx(tp,tp,nil,c)>0
end
function c81012033.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c81012033.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp) end
