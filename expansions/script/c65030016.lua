...
function c65030016.accost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c65030016.costfil,tp,LOCATION_SZONE,0,1,e:GetHandler()) end
	local g=Duel.SelectMatchingCard(tp,c65030016.costfil,tp,LOCATION_SZONE,0,1,1,e:GetHandler())
